...
public class ActorEnemigoCuatro extends Actor {
	...
	public ActorEnemigoCuatro() {
		...
		// ancho
		link = new Texture("img/zombisDos.png");
		...
		rectagulo = new Rectangle(this.getX(), this.getY(), (float) (this.getWidth()*1.2),
				(float) (this.getHeight()*1.2));
