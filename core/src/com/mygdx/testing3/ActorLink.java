...
public class ActorLink extends Actor {
	...
	public ActorLink() {
		...
		rectagulo = new Rectangle(this.getX(), this.getY(), this.getWidth() /2 , this.getHeight() /2);
	...
	// metodo para conseguir la linea de imagenes de link a la izquierda
